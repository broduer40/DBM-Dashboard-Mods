module.exports = {
    ...
    short_description: "Sends a fake nitro to the specified server and channel.",
    ...
    run: async (client, req) => {
        ...
        channel.send("https://discord.gift/S7uX7qtcNAqJxYqA");
        client.log = `Successfully sent the nitro to ${server.name}`;
